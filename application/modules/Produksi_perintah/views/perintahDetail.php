      ...
      <td>
        <table class="nested dok-detail">
          ...
          <tr>
            ...
            <td>: <?= ($perintah_produksi->tanggal_efektif != '') ? date('d.m.Y', strtotime($perintah_produksi->tanggal_efektif)) : 'Not set' ?></td>
          </tr>
        </table>
      </td>
    </tr>
      ...
      <td class="bagi-dua">
        <table class="nested">
          ...
          <tr>
            ...
            <td>: <?php echo empty($perintah_produksi->estimasi_proses) ? '' : $perintah_produksi->estimasi_proses.' hari' ?> </td>
          </tr>
        </table>
      </td>
      <td class="bagi-dua">
        <table class="nested">
          ...
          <tr>
            <td>Expired Date</td>
            <td>: <?= ($perintah_produksi->expired_date != '') ? date('M Y', strtotime($perintah_produksi->expired_date)) : 'Not set' ?> </td>
          </tr>
        </table>
      </td>
    </tr>
  ...
  <table class="regular penimbanganAktual" style="height:100%">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="nope"><?= $row['jumlah_perlot'] > 0 ? $row['jumlah_perlot'] : '&nbsp;' ?></td>
