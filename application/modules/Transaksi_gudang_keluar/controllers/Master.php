...
class Master extends MX_Controller {
    ...
    function data(){
        ...
        $sql.=  " LEFT JOIN m_bahan bahan ON gk.id_bahan = bahan.id
                 LEFT JOIN m_distributor distributor ON gk.id_distributor = distributor.id
                 LEFT JOIN m_satuan satuan ON bahan.id_satuan = satuan.id
                 LEFT JOIN tt_gudang gudang ON gudang.id_gudang = gk.id
                 WHERE gudang.type = 2 ";
