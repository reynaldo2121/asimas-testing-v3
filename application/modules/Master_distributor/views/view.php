           ...
           <div class="row">
             ...
             <div class="col-sm-12">
               <div class="form-group">
                 ...
                 <input type="text" name="alamat" maxlength="150" class="form-control" id="alamat" placeholder="Alamat Distributor" required="">
               </div>
             </div>
             <div class="col-sm-6">
               <div class="form-group">
                 <label for="no_telp">No Telp Distributor</label>
                 <input type="number" min="0" maxlength="50" name="no_telp" class="form-control" id="no_telp" placeholder="No Telp Distributor">
               </div>
             </div>
             <div class="col-sm-6">
               <div class="form-group">
