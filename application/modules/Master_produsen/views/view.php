           ...
           <div class="row">
             ...
             <div class="col-sm-6">
               <div class="form-group">
                 ...
                 <input type="tel" min="0" maxlength="50" name="no_telp" class="form-control" id="no_telp" placeholder="No Telp Produsen">
               </div>
             </div>
             <div class="col-sm-6">
               <div class="form-group">
                 <label for="email">Email Produsen</label>
                 <input type="email" maxlength="50" name="email" class="form-control" id="email" placeholder="Email Produsen">
               </div>
             </div>
           </div>
        </div>
