...
<div class="row" style='min-height:80px;'>
  ...
  <div class="row">
    <h3><strong>Master</strong> - Gudang</h3>
  </div>
...
<script type="text/javascript">
  ...
  function get_kota(){
  	...
  	$.ajax({
  	   url :"<?php echo base_url('Master_gudang/Master/get_kota')?>/",
  	   type : "GET",
  ...
  $("#myform").on('submit', function(e){
    ...
    var action = "<?php echo base_url('Master_gudang/Master/add')?>/";
    if ($("#id").val() != ""){
      action = "<?php echo base_url('Master_gudang/Master/edit')?>/";
	...
	function deleteData(element){
		...
		$.ajax({
          type: 'post',
          url: '<?php echo base_url('Master_gudang/Master/delete'); ?>/',
