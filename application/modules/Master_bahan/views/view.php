           ...
           <div class="row">
             ...
             <div class="col-sm-6">
               <div class="form-group">
                 ...
                 -->
                 <input type="hidden" name="jumlah_keluar" maxlength="50" Required class="form-control" id="jumlah_keluar" placeholder="ID Bahan" value="0">
               </div>
             </div>
             <div class="col-sm-6">
               <div class="form-group">
                 ...
                 -->
                 <input type="hidden" name="jumlah_masuk" maxlength="50" Required class="form-control" id="jumlah_masuk" placeholder="ID Bahan" value="0">
               </div>
             </div>
             <div class="col-sm-6">
               <div class="form-group">
                 ...
                 -->
                 <input type="hidden" name="saldo_kemarin" maxlength="50" Required class="form-control" id="saldo_kemarin" placeholder="ID Bahan" value="0">
               </div>
             </div>
             <!--
             <div class="col-sm-6">
             ...
             -->
             <input type="hidden" name="saldo_sekarang" maxlength="50" Required class="form-control" id="saldo_sekarang" placeholder="ID Bahan" value="0">
             <!--
             <div class="col-sm-6">
               <div class="form-group">
             ...
             -->
             <input type="hidden" name="tgl_datang" maxlength="50" Required class="form-control" id="tgl_datang" placeholder="ID Bahan" value="0000-00-00">
            <!--
            <div class="col-sm-6">
               <div class="form-group">
             ...
             -->
             <input type="hidden" name="expired_date" maxlength="50" Required class="form-control" id="expired_date" placeholder="ID Bahan" value="0000-00-00">
